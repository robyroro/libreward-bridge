...
| Standalone GitHub could not detect CI | Yes | Added the workflow at `.github/workflows/ci.yml`; retained `deployment/standalone-ci.yml` as a template mirror. | The [first public standalone run](https://github.com/robyroro/libreward-bridge/actions/runs/29366192289) passed test, container and secret-scan jobs on 2026-07-14. | Completed. |
